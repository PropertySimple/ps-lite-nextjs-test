...
/**
 * AI Influencer Video Editor Page
 * Allows editing of photos, AI actor, script, and background music for the AI video
 */
export default function AIVideoEditorPage() {
  ...
  const [selectedActors, setSelectedActors] = useState<number[]>([0]);
  const [script, setScript] = useState(
    "Hi! I'm excited to show you this amazing property at 123 Main St. " +
    "This beautiful home features 3 spacious bedrooms, 2 modern bathrooms, " +
    "and an incredible backyard perfect for entertaining. Don't miss out on " +
    "this opportunity - schedule your tour today!"
  );
  ...
  const handleActorSelect = (actorIndex: number) => {
    // Only allow single actor selection
    setSelectedActors([actorIndex]);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900">
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">Edit AI Influencer Video</h1>
          <p className="text-gray-600">
            Select photos, AI actor, customize script, and choose background music
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          {/* Actor and Script */}
          <section>
            <h2 className="text-xl font-semibold mb-4">AI Video Actor & Script</h2>
            <ActorScriptEditor
              ...
              onScriptReviewChange={setScriptReviewed}
            />
          </section>
          ...
          <section className="pt-4">
            <Button
              ...
              disabled={saveStatus === 'saving' || !scriptReviewed}
              title={!scriptReviewed ? "Please review the script before saving" : ""}
